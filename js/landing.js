...
const DATA = [
  ...
  { name:"김지원", A:"입", B:"팩스기", thumb:"p06.jpg", poster:"kjiwon_poster.jpg", en:"Jiwon Kim", koTitle:"입은 팩스기다", enSentence:"A MOUTH IS A FAX MACHINE", insta:"@march_jk", descKo:"인간의 발화 구조를 팩스 시스템에 빗대어, ‘입은 팩스기다’라는 가상의 명제를 제안한다. 인간은 외부로부터 다양한 정보를 입력받아 내부에서 가공한 뒤 다시 외부로 출력한다. 이 과정에서 뇌는 정보를 생성하고, 입은 이를 언어로 변환해 전달하는 출력 장치로 기능한다. 서로 다른 설정값을 가진 16개의 입과 그 출력물을 통해, 소통이 원본을 온전히 전달할 수 없는 불완전한 통신 과정임을 드러낸다.", descEn:"“The Mouth Is a Fax Machine” compares human speech to a fax transmission system. Thoughts generated in the brain are output through the mouth as language, becoming compressed and distorted in the process. Through 16 differently configured mouths and their fax outputs, the work reveals communication as an imperfect process in which the original can never be fully transmitted." , images:["assets/images/05_kjiwon/01.jpg", "assets/images/05_kjiwon/02.jpg", "assets/images/05_kjiwon/03.jpg", "assets/images/05_kjiwon/04.jpg", "assets/images/05_kjiwon/05.png"] },
  { name:"백단하", A:"사거리", B:"갤러리", thumb:"p07.jpg", poster:"danha_poster.jpg", en:"Danha Baek", koTitle:"사거리는 갤러리다", enSentence:"The crossroads is a gallery", insta:"@badookdol", descKo:"와우산로와 홍익로가 교차하는 사거리를 하나의 갤러리로 재해석한다. 이동을 멈추고 무언가 응시하게 되는 신호 대기 시간을 작품 감상의 순간으로 바라보고, 화이트 큐브의 문법을 차용해 일상의 풍경을 관람 대상으로 전환한다. 관람자는 현실의 사거리와 가상의 갤러리가 교차하는 영상 속에서 자신의 실루엣을 마주하며, 신호를 기다리는 행위가 전시를 관람하는 태도와 크게 다르지 않음을 경험한다.", descEn:"This work reimagines the intersection of Wausan-ro and Hongik-ro as a gallery. It turns the brief pause at a traffic light into a moment of looking, borrowing the language of the white cube to frame an everyday street scene as an exhibition. In the video, the real crossroads and a virtual gallery alternate at regular intervals, allowing viewers to encounter their own silhouettes and experience waiting as a form of viewing." , videoUrl:"https://www.youtube.com/watch?v=e1wry2fPNIo" , images:["assets/images/06_danha/01.jpg", "assets/images/06_danha/02.jpg", "assets/images/06_danha/03.jpg", "assets/images/06_danha/04.jpg"] },
  ...
  { name:"이지희", A:"손톱", B:"플레이리스트", thumb:"p15.png", poster:"jihee_poster.jpg", en:"Jihee Lee", koTitle:"손톱은 플레이리스트다", enSentence:"Nails are a playlist", insta:"@lee.zhixi", descKo:"플레이리스트에 좋아하는 곡을 담아 손가락을 길러보세요. 손톱이 길어질수록 당신의 플레이리스트엔 음악이 차오릅니다. 하지만 길어진 손톱은 영원히 머물지 못합니다.", descEn:"Add the songs you love to your playlist, and let your nails grow. The longer they grow, the more your playlist fills with music — yet nails, once grown, cannot remain forever." , videoUrl:"https://youtu.be/L4oTJ57m98Q" , images:["assets/images/14_jihee/01.png", "assets/images/14_jihee/02.png", "assets/images/14_jihee/03.png", "assets/images/14_jihee/04.png"] },
  ...
  { name:"김성재", A:"이어폰", B:"탯줄", thumb:"p19.jpg", poster:"seongjae_poster.jpg", en:"Seongjae Kim", koTitle:"이어폰은 탯줄이다", enSentence:"EARPHONES ARE AN UMBILICAL CORD", insta:"@infth", descKo:"이어폰은 탯줄이다. 두 대상은 서로 다른 두 존재를 연결하고, 그 연결을 통해 한쪽은 다른 한쪽으로 무언가를 공급한다. 탯줄이 태반을 거쳐 태·배아에 산소와 영양분을 전달하듯, 이어폰은 신호원과 귀를 이어 음악을 전달한다. 연결된 동안 외부 세계와 단절된다는 점도, 살기 위해 연결되어야 한다는 점도 같다. 생물학적 생존과 정서적 생존이라는 형태만 다를 뿐이다. 인터넷 슬랭 ‘mother’는 이 거짓말을 완성하는데, 단순 애정을 넘어 여성 아티스트에게 존경과 의존을 표하는 이 호칭은 아티스트와 팬의 관계가 모자 관계에 가깝다는 것을 말해준다. 문화는 이 거짓말을 이미 알고 있다. 본 작업은 그 사실을 표상하는 시도이기도 하다.<br><br>형식은 산모 수첩이다. 30명의 참가자(fetus)는 자신의 삶에 영향을 준 여성 아티스트(mother) 한 명을 선정하고, 유선 이어폰을 착용한 셀카와 설문 응답을 제출했다. ‘이어폰 셀카’는 네거티브 이미지와 환형 부채꼴 프레임, 노이즈, 의료 장비 특유의 그래픽을 거쳐 변환됐고, 아티스트의 ‘최애’ 트랙 정보, 사진 촬영 시각, 이어폰-귀 사이의 거리·위치를 비롯한 수치와 함께 초음파 사진으로 완성됐다. 진료 기록과 일기의 자리는 인터뷰가 채웠고, 최애 트랙에서 추출한 초음파 파형은 인터뷰 페이지 위에 흐른다. 인터뷰는 이어폰이 어떻게 탯줄로 기능하는지에 대한 증언이다. 동시대의 주된 신호원인 아이폰의 비율을 가져와 완성된 252페이지의 책은 각기 다른 어머니, 각기 다른 탯줄을 가진 이들의 이야기를 통해 음악 청취가 단순 행위를 넘어 한 사람의 생존을 좌우한다는 것을 보여준다. 여성 아티스트는 어머니다. 청취자는 태아다. 음악은 영양분이다. 이어폰은 탯줄이다.", descEn:"FEMALE ARTISTS ARE MOTHERS. LISTENERS ARE FETUSES. MUSIC IS NOURISHMENT. EARPHONES ARE AN UMBILICAL CORD." , images:["assets/images/18_seongjae/1.jpg", "assets/images/18_seongjae/6.gif"] },
